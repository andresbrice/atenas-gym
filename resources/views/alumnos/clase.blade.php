                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-2 2xl:p-4 bg-white border-b border-gray-200">
                        ...
                        <div class="flex flex-col md:flex-row">
                            <div
                                class="flex-1 m-3 w-full overflow-hidden bg-gray-900 rounded-lg shadow-lg dark:bg-gray-800">
                                <div class="px-4 py-2">
                                    <h1 class="text-2xl font-bold text-gray-100 uppercase dark:text-white">Tipo de Clase
                                    </h1>
                                    <p class="mt-1 text-lg text-gray-100 dark:text-gray-400">Funcional</p>
                                </div>
                                <div class="px-4 py-2">
                                    <h1 class="text-2xl font-bold text-gray-100 uppercase dark:text-white">Días</h1>
                                    <p class="mt-1 text-lg text-gray-100 dark:text-gray-400">Lunes - Miercoles - Viernes
                                    </p>
                                </div>
                                <div class="px-4 py-2">
                                    <h1 class="text-2xl font-bold text-gray-100 uppercase dark:text-white">Horarios</h1>
