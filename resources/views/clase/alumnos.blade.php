        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-2 2xl:p-4 bg-white border-b border-gray-200">
            ...
            <div class="flex flex-col md:flex-row items-center">
              <div class="flex-1 m-3 max-w-max overflow-hidden bg-gray-100 rounded-lg shadow-lg ">
                <x-table>
                  @section('id')
                  tablaAlumnos
                  @endsection
                  @section('nombre-columna')
                  <h1 class="text-center">Listado de</h1>
                  <tr>
                    <th scope="col"
                  ...
                  <form action="{{route('clase.addAlumnos')}}">
                    <tr>
                      ...
                      <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                        {{-- BOTON EDITAR --}}
                        <x-button type="submit" class="btnSeleccionar[] text-white bg-yellow-600 hover:bg-yellow-700">
                          Seleccionar
                        </x-button>
                      </td>
                    </tr>
