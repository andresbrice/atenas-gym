              ...
              <tr>
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                  ...
                  <x-dropdown class="origin-top-right right-auto" width="48"
                    contentClasses="bg-white rounded-md ring-1 ring-blue-700 text-blue-800" class="inline-flex">
                    <x-slot name="trigger">
                  ...
                  <x-dropdown class="origin-top-right right-auto" width="48"
                    contentClasses="bg-white rounded-md ring-1 ring-yellow-500 text-black" class="inline-flex">
                    <x-slot name="trigger">
...
<div class="md:flex md:items-center space-x-2">
  <x-input type="text" id="ClassName" name="ClassName" value="{{Request::input('ClassName')}}" class=" mt-1 rounded-xl border-transparent flex-1 appearance-none border shadow-sm text-base
                  focus:outline-none focus:ring-2 focus:border-transparent" placeholder="{{__('Search Class...')}}"
    autocomplete="off" />
