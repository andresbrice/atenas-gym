       ...
       <div class="flex flex-col p-4 overflow-hidden sm:rounded-md">
        ...
        <div class="grid grid-cols-6 gap-4">
         ...
         <div class="col-span-6 sm:col-span-6 lg:col-span-2">
          ...
          <x-input id="dni" class="block w-full px-4 py-2 mt-2" type="text" name="dni" :value="old('dni')" required />
         </div>
         <div class="col-span-6 sm:col-span-6 lg:col-span-2">
         ...
         <div class="col-span-6 sm:col-span-6 lg:col-span-2">
          ...
          <x-input id="age" class="block w-full px-4 py-2 mt-2" type="text" name="age" :value="old('age')" required />
         </div>
         <div class="col-span-6 sm:col-span-6 lg:col-span-2">
