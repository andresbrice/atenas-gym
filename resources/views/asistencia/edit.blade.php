<x-app-layout>
    ...
    <x-slot name="breadcrumb">
        <x-breadcrumb><a href="/">Dashboard</a> / <a href="{{ route('asistencia.edit') }}">Gestión Asistencia</a> /
            <u>Editar
                Asistencia</u>
        </x-breadcrumb>
    </x-slot>
                            ...
                            <div class="px-4 py-5 bg-white sm:p-6">
                                ...
                                <div class="grid grid-cols-2 gap-6">
                                    <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                        ...
                                        <x-input id="fecha" class="block w-full px-4 py-2 mt-2" type="date" name="fecha"
                                ...
                                <div class="grid grid-cols-2 gap-6">
                                    <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                        ...
                                        <x-input id="horario" class="block w-full px-4 py-2 mt-2" type="time"
                                            name="horario" :value="{{ $horario->hora->format('H:i A') }}" required
                                            autofocus />
                                    </div>
                                </div>
                                <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                    ...
                                    <x-input id="tipo_clase" class="block w-full px-4 py-2 mt-2" type="text"
                                        name="tipo_clase" :value="{{ old('tipo_clase', $clase->tipo_clase) }}" required
                                        autofocus />
                                </div>
