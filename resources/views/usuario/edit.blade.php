              ...
              <div class="flex flex-col p-4 overflow-hidden sm:rounded-md">
                ...
                <div class="grid grid-cols-6 gap-4">
                  ...
                  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                    ...
                    <x-input id="dni" class="block w-full px-4 py-2 mt-2" type="text" name="dni" value="{{old('dni', $usuario->dni)}}"
                      required />
                  </div>
                  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                    <x-label for="name" :value="__('Name')" class="font-semibold" />
                    <x-input id="name" class="block w-full px-4 py-2 mt-2" type="text" name="name" value="{{old('name', $usuario->name)}}"
                      required />
                  </div>
                  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                  ...
                  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                    ...
                    <x-input id="age" class="block w-full px-4 py-2 mt-2" type="text" name="age" value="{{old('age', $usuario->age)}}"
                      required />
                  </div>
                  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                  ...
                  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                    ...
                    <x-input id="emergency_number" class="block w-full px-4 py-2 mt-2" type="text"
                      name="emergency_number" value="{{old('emergency_number', $usuario->emergency_number)}}" required />
                  </div>
                  <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                  ...
                  <div class="inline grid-cols-6 space-x-2 gap-6 ">
                    ...
                    <label for="eRespiratorias" class="inline-flex items-center">
                      ...
                      <input id="eRespiratorias" type="checkbox"
                        ...
                        name="eRespiratorias" value="1" {{$usuario->eRespiratorias || old('eRespiratorias',0) === 1 ? 'checked' : ''}}>
                    ...
                    <label for="convulsiones" class="inline-flex items-center">
                      ...
                      <input id="convulsiones" type="checkbox"
                        class="rounded border-gray-300 text-red-900 shadow-sm focus:border-red-300 focus:ring focus:ring-red-200 focus:ring-opacity-50"
                        name="convulsiones" value="1" {{$usuario->convulsiones || old('convulsiones',0) === 1 ? 'checked' : ''}}>
