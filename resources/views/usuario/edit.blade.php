                                ...
                                <div class="grid grid-cols-6 gap-4">
                                    <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                        ...
                                        <x-input id="userName" class="block w-full px-4 py-2 mt-2" type="text"
                                            name="userName" value="{{ old('userName', $usuario->userName) }}" required
                                            autofocus />
                                    </div>
                                    <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                        <x-label for="email" :value="__('Email')" class="font-semibold" />
                                        <x-input id="email" class="block w-full px-4 py-2 mt-2" type="email"
                                    ...
                                    <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                        ...
                                        <x-input id="lastName" class="block w-full px-4 py-2 mt-2" type="text"
                                            name="lastName" value="{{ old('lastName', $usuario->lastName) }}"
                                            required />
                                    </div>
                                    <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                        ...
                                        <select id="gender"
                                            ...
                                            <option value="Masculino"
                                                {{ $usuario->gender === 'Masculino' ? 'selected' : '' }}>
                                                Masculino
                                            </option>
                                            <option value="Femenino"
                                                {{ $usuario->gender === 'Femenino' ? 'selected' : '' }}>
                                                Femenino
                                            </option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                        ...
                                        <x-input id="age" class="block w-full px-4 py-2 mt-2" type="text" maxlength="2"
                                            name="age" value="{{ old('age', $usuario->age) }}" required />
                                    </div>
                                    <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                    ...
                                    <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                        <x-label for="emergency_number" :value="__('Emergency Number')"
                                            class="font-semibold" />
                                        <x-input id="emergency_number" class="block w-full px-4 py-2 mt-2" type="text"
                                            name="emergency_number"
                                            value="{{ old('emergency_number', $usuario->emergency_number) }}"
                                            required />
                                    </div>
                                    <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                        ...
                                        <select id="roles"
                                            ...
                                            @foreach ($roles as $role)
                                                <option value="{{ $role->id }}"
                                                    {{ $usuario->role->id == $role->id ? 'selected' : '' }}>
                                                    {{ $role->nombre_rol }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="my-3">
                                    <div class="inline grid-cols-6 space-x-2 gap-6 ">
                                        ...
                                        <label for="eRespiratorias" class="inline-flex items-center">
                                            ...
                                            <span
                                                class="ml-2 text-sm text-gray-600">{{ __('E. Respiratorias') }}</span>
                                        </label>
                                        ...
                                        <label for="eRenal" class="inline-flex items-center">
                                            ...
                                            <input id="eRenal" type="checkbox"
                                                class="rounded border-gray-300 text-red-900 shadow-sm focus:border-red-300 focus:ring focus:ring-red-200 focus:ring-opacity-50"
                                                name="eRenal" value="1"
                                                {{ $usuario->eRenal || old('eRenal', 0) === 1 ? 'checked' : '' }}>
                                        ...
                                        <label for="diabetes" class="inline-flex items-center">
                                            ...
                                            <input id="diabetes" type="checkbox"
                                                ...
                                                {{ $usuario->diabetes || old('diabetes', 0) === 1 ? 'checked' : '' }}>
                                        ...
                                        <label for="asma" class="inline-flex items-center">
                                            ...
                                            <input id="asma" type="checkbox"
                                                class="rounded border-gray-300 text-red-900 shadow-sm focus:border-red-300 focus:ring focus:ring-red-200 focus:ring-opacity-50"
                                                name="asma" value="1"
                                                {{ $usuario->asma || old('asma', 0) === 1 ? 'checked' : '' }}>
                                        ...
                                        <label for="alergia" class="inline-flex items-center">
                                            ...
                                            <input id="alergia" type="checkbox"
                                                class="rounded border-gray-300 text-red-900 shadow-sm focus:border-red-300 focus:ring focus:ring-red-200 focus:ring-opacity-50"
                                                name="alergia" value="1"
                                                {{ $usuario->alergia || old('alergia', 0) === 1 ? 'checked' : '' }}>
