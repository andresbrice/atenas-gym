<div x-data="select({ data: {@yield('campos-select')}, emptyOptionsMessage: '@yield('empty')', name: '@yield('name')', placeholder: '@yield('placeholder')' })"
...
<script>
    function select(config) {
        return {
            ...
            emptyOptionsMessage: config.emptyOptionsMessage ?? 'Ningun resultado. Intente nuevamente.',
