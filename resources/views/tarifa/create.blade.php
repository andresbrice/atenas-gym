                            ...
                            <div class="flex flex-col p-4 overflow-hidden sm:rounded-md">
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="col-span-6 sm:col-span-6 lg:col-span-2">
                                        <x-label for="cantidad_dias" :value="__('Cantidad de Dias')"
                                            class="font-semibold" />
                                        <x-input id="cantidad_dias" class="block w-full px-4 py-2 mt-2" type="text"
                                            name="cantidad_dias" :value="old('cantidad_dias')" required autofocus />
                                    </div>
                                    <div class="col-span-6 sm:col-span-6 lg:col-span-2">
