          ...
          <div class="bg-white mt-5 overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-4 bg-white border-b border-gray-100">
              ...
              <div class="flex justify-center items-center bg-white mx-auto mb-3 ">
                ...
                {{--BUSQUEDA--}}
                {{-- <form action="{{route('ejercicio.index')}}" method="GET"
                        ...
                        <tbody class="bg-white divide-y divide-red-100">
                          ...
                          <tr>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                              {{-- BOTON EDITAR --}}
                              <a href="{{route('ejercicio.edit',$ejercicio->id)}}">
                                <x-button class="text-white bg-green-800 hover:bg-green-700">Editar</x-button>
                              </a>
  
                              {{-- BOTON BORRAR --}}
                              <form action="{{route('ejercicio.destroy',$ejercicio->id)}}" method="post" class="inline">
                                @csrf
                                @method('DELETE')
  
                                <x-button class="text-white bg-red-900 hover:bg-red-700"
                                  onclick="return confirm('¿Quieres borrar este ejercicio?')">
                                  Borrar</x-button>
                              </form>
                            </td>
                          </tr>
