                ...
                <div class="px-4 py-5 bg-white sm:p-6">
                  <div class="grid grid-cols-2 gap-6">
                    <div class="col-span-6">
                      ...
                      <x-input id="nombre_ejercicio" class="block w-full px-4 py-2 mt-2" type="text" name="nombre_ejercicio" value="{{old('nombre_ejercicio',$ejercicio->nombre_ejercicio)}}"
                        required autofocus />
                    </div>
                    <div class="col-span-6">
                        ...
                        focus:border-red-300 focus:ring focus:ring-red-200 focus:ring-opacity-50" rows="3" cols="50" minlength="10" value="{{old('descripcion',$ejercicio->descripcion)}}"required autofocus >{{$ejercicio->descripcion}}</textarea>
                      </div>
                  </div>
